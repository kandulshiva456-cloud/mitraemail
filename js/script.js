...
/* O&M data flow */
const FLOW_OM = [
  'Inspection', 'Measurement', 'Diagnosis', 'Preventive Maintenance', 'Report', 'Follow-up'
];
...
const SERVICES = [
  {
    ...
    detail: 'A documented operations and maintenance programme covering field cleaning, maintenance, monitoring, reporting and plant improvement.' ,
    openPanel: 'om', actionLabel: 'Open O&M'
  },
  {
    id: 'epc', num: '02', name: 'EPC', icon: 'bolt',
...
/* EPC project execution sequence */
const EPC_STAGES = [
...
/* O&M dashboard items — client-approved service list. */
const OM_ITEMS = [
  { name: 'Module Cleaning', text: 'Module cleaning delivered through two methods — manual cleaning and robotic cleaning — selected to suit plant conditions and operational requirements.' },
  { name: 'Inverter Maintenance', text: 'Preventive and corrective maintenance of solar inverters to ensure reliable operation, minimize downtime, and extend equipment service life.' },
  { name: 'Plant Monitoring & Performance', text: 'Continuous monitoring and analysis of plant performance to detect faults, generation losses, and performance deviations, enabling timely corrective action.' },
  { name: 'Reporting', text: 'Accurate generation, performance, and maintenance reports providing clear insights into plant health, operational trends, and maintenance requirements.' },
  { name: 'Inverter Communication', text: 'Reliable communication between inverters and monitoring systems to ensure accurate real-time data acquisition and effective plant performance monitoring.' },
  { name: 'Plant Thermography', text: 'Thermal inspection of solar and electrical equipment to identify hotspots, loose connections, and abnormal heating before they develop into major failures.' },
  { name: 'Chemical Cleaning', text: 'Specialized cleaning to remove stubborn stains, mineral deposits, and other contaminants from PV modules, helping restore optimal surface performance.' },
  { name: 'Revamping', text: 'Upgrading or replacing outdated and underperforming components to improve plant efficiency, reliability, energy generation, and operational life.' }
];

const OM_MODULE_CLEANING_OPTIONS = [
  { name: 'Manual Module Cleaning', text: 'Professional manual cleaning of PV modules using field cleaning tools and water to remove dust, dirt, and surface contaminants, helping maintain module efficiency and maximize energy generation.', image: 'assets/optimized/site/om-module-cleaning/module-cleaning-1.webp' },
  { name: 'Robot Module Cleaning', text: 'Automated robotic cleaning of PV modules to remove dust and surface contaminants efficiently while supporting consistent cleaning across the plant.', image: 'assets/optimized/site/om-module-cleaning/module-cleaning-6.webp' }
];

const OM_IMAGES = {
  'Module Cleaning': 'assets/optimized/site/om-module-cleaning/module-cleaning-1.webp',
  'Inverter Maintenance': 'assets/optimized/site/electrical-maintenance/inverter-maintenance-1.webp',
  'Plant Monitoring & Performance': 'assets/optimized/site/plant/solar-plant-overview.webp',
  'Reporting': 'assets/optimized/site/plant/reporting-stock.webp',
  'Inverter Communication': 'assets/optimized/site/electrical-communication/communication-panel-1.webp',
  'Plant Thermography': 'assets/optimized/site/inspection-thermography/thermal-inspection-1.webp',
  'Chemical Cleaning': 'assets/optimized/site/module-surface-care/surface-care-1.webp',
  'Revamping': 'assets/optimized/client-supplied/revamp/whatsapp-image-2026-03-19-at-6-35-18-pm-1.webp'
};

const OM_IMAGE_GALLERIES = {
  'Module Cleaning': [...OM_MODULE_CLEANING_OPTIONS.map(option => option.image), 'assets/optimized/site/om-module-cleaning/module-cleaning-7.webp'],
  'Inverter Maintenance': ['assets/optimized/site/electrical-maintenance/inverter-maintenance-1.webp','assets/optimized/client-supplied/inverter-maintenance/o-m-inverter-temperature.webp','assets/optimized/client-supplied/inverter-maintenance/inverter-maintenance-7.webp','assets/optimized/client-supplied/inverter-maintenance/inverter-maintenance-8.webp','assets/optimized/client-supplied/inverter-maintenance/inverter-maintenance-9.webp','assets/optimized/client-supplied/inverter-maintenance/inverter-maintenance-10.webp','assets/optimized/client-supplied/inverter-maintenance/inverter-maintenance-11.webp'],
  'Plant Monitoring & Performance': ['assets/optimized/site/plant/solar-plant-overview.webp'],
  'Reporting': ['assets/optimized/site/plant/reporting-stock.webp'],
  'Inverter Communication': ['assets/optimized/site/electrical-communication/communication-panel-1.webp','assets/optimized/site/electrical-communication/communication-panel-2.webp'],
  'Plant Thermography': ['assets/optimized/site/inspection-thermography/thermal-inspection-1.webp','assets/optimized/site/inspection-thermography/thermal-inspection-2.webp','assets/optimized/site/inspection-thermography/thermal-inspection-3.webp'],
  'Chemical Cleaning': ['assets/optimized/site/module-surface-care/surface-care-1.webp','assets/optimized/site/module-surface-care/surface-care-2.webp','assets/optimized/site/om-module-cleaning/module-cleaning-4.webp'],
  'Revamping': ['assets/optimized/client-supplied/revamp/whatsapp-image-2026-03-19-at-6-35-18-pm-1.webp','assets/optimized/client-supplied/revamp/whatsapp-image-2026-04-01-at-1-57-19-pm.webp']
};
...
const GALLERY = [
  ...
  { src: 'assets/optimized/site/plant/plant-site-2.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Solar plant rooftop module field' },
  { src: 'assets/optimized/site/plant/plant-site-3.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Solar PV module array and site terrain' },
  { src: 'assets/optimized/site/plant/plant-site-4.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Rooftop solar installation overview' },
  ...
  { src: 'assets/optimized/client-supplied/monitoring-reporting/plant-monitoring-report.webp', cat: 'monitoring', tag: 'Plant Monitoring', cap: 'Plant monitoring and performance report' },
  { src: 'assets/optimized/site/om-module-cleaning/module-cleaning-7.webp', cat: 'cleaning', tag: 'Module Cleaning', cap: 'Manual module cleaning — field operation' },
  { src: 'assets/optimized/client-supplied/inverter-maintenance/inverter-maintenance-11.webp', cat: 'inverter', tag: 'Inverter Maintenance', cap: 'Inverter cooling fan maintenance' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-7.webp', cat: 'epc', tag: 'EPC & Construction', cap: 'Civil execution and site preparation' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-8.webp', cat: 'epc', tag: 'EPC & Construction', cap: 'PV structure and module installation' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-9.webp', cat: 'epc', tag: 'EPC & Construction', cap: 'Structure foundation and field execution' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-10.webp', cat: 'epc', tag: 'EPC & Construction', cap: 'Survey and setting-out work' },
  ];
...
/* Team — client-approved names and roles. */
const TEAM = [
  { name: 'Prajakta Kulkarni', role: 'Managing Director', img: 'assets/optimized/team/prajkta-kulkarni.webp', mobileImg: 'assets/optimized/team/prajkta-kulkarni.webp', lead: true, stage: 'PROJECT DIRECTION', desc: 'Strategic direction, client alignment and the decisions that keep a project moving from requirement to delivery.', focus: ['Strategy', 'Client Alignment', 'Direction'] },
  { name: 'Amrut Bugad', role: 'Project & Asset Manager', img: 'assets/team/amrut-bugad-cutout.png', mobileImg: 'assets/optimized/team/amrut-bugad-cutout.webp', lead: true, stage: 'PROJECT DELIVERY', desc: 'Coordinates project delivery and asset responsibilities across the operating lifecycle, keeping execution and follow-through connected.', focus: ['Project Delivery', 'Asset Management', 'Coordination'] },
  { name: 'Babu Ghevade', role: 'EPC Engineer', img: 'assets/team/babu-ghevade-cutout.png', mobileImg: 'assets/optimized/team/babu-ghevade-cutout.webp', stage: 'FIELD EXECUTION', desc: 'Supports EPC execution on site, translating the approved project sequence into coordinated field activity.', focus: ['EPC Execution', 'Site Supervision', 'Field Coordination'] },
  { name: 'Ravi Kumar', role: 'Site Supervisor', img: 'assets/team/ravi-kumar-cutout.png', mobileImg: 'assets/optimized/team/ravi-kumar-cutout.webp', stage: 'SITE CONTROL', desc: 'Supports day-to-day site execution, keeping field activities aligned with the planned work sequence.', focus: ['Site Execution', 'Work Coordination', 'Quality Focus'] },
  { name: 'Rushikesh Ubale', role: 'Sr O&M Supervisor', img: 'assets/team/rushikesh-ubale-cutout.png', mobileImg: 'assets/optimized/team/rushikesh-ubale-cutout.webp', stage: 'ASSET PERFORMANCE', desc: 'Supports O&M field activity, maintenance response and the practical work required to keep solar assets operating reliably.', focus: ['O&M', 'Maintenance', 'Field Response'] }
];
...
const MAITRA_CLIENTS = [
  ...
  'Purushotam Solar', 'Prozeal', 'CBRE South Asia Pvt. Ltd.', 'AFRY'
];
...
navToggle.addEventListener('click', () => {
  const open = navToggle.getAttribute('aria-expanded') === 'true';
  if (open) closeMobileMenu(true);
  else openMobileMenu();
});

menuClose?.addEventListener('click', () => closeMobileMenu(true));
...
function openPanel(panelId, options = {}) {
  ...
  const panelBack = $('.panel-back', panelShell);
  if (panelBack) {
    const hasHistory = panelHistory.length > 0;
    panelBack.setAttribute('aria-label', hasHistory ? 'Go back to previous panel' : 'Back to main website');
    panelBack.querySelector('span').textContent = hasHistory ? 'BACK' : 'BACK';
  }
...
function openServiceModal(id) {
  ...
  const html = `<div class="ix-detail">
    ...
    <div style="margin-top:24px;display:flex;gap:12px;flex-wrap:wrap">
      <button class="btn btn-primary" type="button" data-modal-back="services">← Back to Services</button>
...
document.addEventListener('click', (e) => {
  ...
  /* O&M service images — open the existing image viewer without opening the detail modal */
  const omImageTrigger = e.target.closest('[data-om-image]');
  if (omImageTrigger) {
    const name = omImageTrigger.getAttribute('data-om-image');
    const index = Number(omImageTrigger.getAttribute('data-om-image-index')) || 0;
    const gallery = OM_IMAGE_GALLERIES[name] || (OM_IMAGES[name] ? [OM_IMAGES[name]] : []);
    if (gallery.length) {
      lightboxList = gallery.map((src, i) => ({
        g: { src, tag: name, cap: `${name} — field imagery ${i + 1}` },
        i
      }));
      lightboxIndex = Math.min(index, lightboxList.length - 1);
  ...
  const moduleCleaningImage = e.target.closest('[data-module-cleaning-lightbox]');
  if (moduleCleaningImage) {
    const index = Number(moduleCleaningImage.getAttribute('data-module-cleaning-lightbox')) || 0;
    const entries = OM_MODULE_CLEANING_OPTIONS.map(option => ({
      g: { src: option.image, tag: 'Module Cleaning', cap: option.name },
      i: 0
    }));
    lightboxList = entries;
    lightboxIndex = Math.min(index, entries.length - 1);
    if (lightboxTitle) lightboxTitle.textContent = 'Module Cleaning';
    if (lightboxCount) lightboxCount.textContent = `${entries.length} images`;
    lightboxEl.hidden = false;
    lightboxEl.setAttribute('aria-hidden', 'false');
    if (lightboxThumbs) lightboxThumbs.innerHTML = '';
    showLightboxImage();
...
function renderEpcPanel() {
  ...
  return `<div class="ix ix-epc"><div class="ix-subnav"><button class="ix-back" type="button" data-back-panel>← Services</button><span>EPC</span><span>10 STAGES</span></div><div class="ix-command-intro"><div><p class="ix-kicker">PROJECT DELIVERY / 02.02</p><h3>Execution<br><span>Sequence.</span></h3></div><p>Every project moves through a disciplined engineering sequence from mobilization to handover, with each stage visible and accountable.</p></div><div class="ix-progress"><span>SEQUENCE PROGRESS</span><div id="epcBar"></div><strong id="epcCount">0 / ${EPC_STAGES.length} stages</strong></div><div class="ix-epc-list">${stages}</div></div>`;
}
...
function renderOmPanel() {
  const items = OM_ITEMS.map((it,i) => {
    const image = OM_IMAGES[it.name] || '';
    const isModuleCleaning = it.name === 'Module Cleaning';
    const subOptions = isModuleCleaning ? `<span class="ix-om-card-suboptions" aria-label="Module Cleaning options">${OM_MODULE_CLEANING_OPTIONS.map(option => `<span>${esc(option.name)}</span>`).join('')}</span>` : '';
    return `<article class="ix-om-card om-item ${isModuleCleaning ? 'ix-om-module-cleaning' : ''}" data-om-name="${esc(it.name)}" role="listitem">
      <button class="ix-om-card-trigger" type="button" data-om-detail="${esc(it.name)}" aria-label="Open ${esc(it.name)} service details">
        <span class="ix-om-card-media" data-om-image="${esc(it.name)}" data-om-image-index="0" role="button" tabindex="0" aria-label="View ${esc(it.name)} images"><img src="${image}" alt="${esc(it.name)}" loading="lazy"><i aria-hidden="true"></i><b>${String(i+1).padStart(2,'0')}</b></span>
        <span class="ix-om-card-copy"><strong>${esc(it.name)}</strong><small>${esc(it.text)}</small>${subOptions}<em>VIEW DETAILS <span aria-hidden="true">→</span></em></span>
      </button>
    </article>`;
  }).join('');
  return `<div class="ix ix-om"><div class="ix-subnav"><button class="ix-back" type="button" data-back-panel>← Services</button><span>O&amp;M / ASSET CARE</span><span>08 SERVICES</span></div><div class="ix-om-hero"><div class="ix-om-copy"><p class="ix-kicker">OPERATIONS / 02.01</p><h3>Protection<br><span>after installation.</span></h3><p>O&amp;M services designed to protect plant performance, reliability and operating life through disciplined field and monitoring practices.</p><div class="ix-stats"><span><b>08</b> services</span><span><b>06</b> operating steps</span><span><b>01</b> accountable team</span></div></div><div class="ix-om-media"><video autoplay muted loop playsinline preload="metadata" aria-label="Maitra Solar Solutions O&amp;M field maintenance video"><source src="assets/video/maitra-om-maintenance.mp4" type="video/mp4"></video><div></div><span>FIELD MAINTENANCE / ASSET CARE</span></div></div><div class="ix-cycle"><p class="ix-kicker">OPERATING CYCLE</p><div>${FLOW_OM.map((f,i)=>`<span><b>${String(i+1).padStart(2,'0')}</b>${esc(f)}</span>`).join('')}</div></div><div class="ix-om-list" role="list" aria-label="O&amp;M services">${items}</div></div>`;
}
function openOmServiceModal(name) {
  if (name === 'Module Cleaning') {
    const options = OM_MODULE_CLEANING_OPTIONS.map((option, index) => `
      <article class="module-cleaning-option">
        <button class="module-cleaning-option-media" type="button" data-module-cleaning-lightbox="${index}" aria-label="View ${esc(option.name)} image larger">
          <img src="${option.image}" alt="${esc(option.name)}" loading="eager">
          <span class="module-cleaning-option-zoom" aria-hidden="true">VIEW IMAGE ↗</span>
        </button>
        <div class="module-cleaning-option-copy">
          <h3>${esc(option.name)}</h3>
          <p>${esc(option.text)}</p>
        </div>
      </article>`).join('');
    const html = `
      <h2 class="modal-title">Module Cleaning</h2>
      <p class="modal-sub">Choose a cleaning method.</p>
      <div class="module-cleaning-options">${options}</div>
      <div class="service-detail-meta"><span>O&amp;M</span><span>MODULE CLEANING</span><span>MAITRA</span></div>
    ...
    <div class="team-showcase" id="teamShowcase">
      ...
      <div class="team-roster team-roster-horizontal" role="list" aria-label="Maitra team profiles">
        ${TEAM.map((m, i) => `
          <button class="team-roster-item ${i === 0 ? 'is-active' : ''}" type="button" data-team-person="${i}" aria-pressed="${i === 0 ? 'true' : 'false'}">
            ...
            <span class="team-roster-thumb ${i === 0 ? 'is-photo' : 'is-cutout'}"><picture>${m.mobileImg ? `<source media="(max-width: 700px)" srcset="${m.mobileImg}">` : ''}<img src="${m.img}" alt="" loading="${i === 0 ? 'eager' : 'lazy'}"></picture></span>
            <span class="team-roster-copy"><strong>${esc(m.name)}</strong><small>${esc(m.role)}</small></span>
      ...
      <div class="team-feature team-feature-compact" id="teamFeature">
        <div class="team-feature-visual ${lead.lead ? 'is-photo' : 'is-cutout'}">
          ...
          <img id="teamFeatureImg" src="${teamImageSrc(lead)}" data-desktop-src="${lead.img}" data-mobile-src="${lead.mobileImg || lead.img}" alt="${esc(lead.name)} — ${esc(lead.role)}" loading="eager">
        ...
        <div class="team-feature-copy">
          ...
          <h3 id="teamFeatureName">${esc(lead.name)}</h3>
          <p class="team-feature-role" id="teamFeatureRole">${esc(lead.role)}</p>
...
function setTeamPanelPerson(index) {
  ...
  setTimeout(() => {
    img.src = teamImageSrc(member);
    img.dataset.desktopSrc = member.img;
    img.dataset.mobileSrc = member.mobileImg || member.img;
  ...
  return `
    <article class="team-card">
      <div class="team-photo ${m.lead ? '' : 'is-cutout'}">
        <picture>${m.mobileImg ? `<source media="(max-width: 700px)" srcset="${m.mobileImg}">` : ''}<img src="${m.img}" alt="${esc(m.role)}" loading="lazy"></picture>
      </div>
      <div class="team-info">
...
function initLeadershipStory() {
  ...
  function setPerson(index) {
    ...
    if (!member) return;
    activePerson = index;
    featureImg.src = teamImageSrc(member);
    featureImg.dataset.desktopSrc = member.img;
    featureImg.dataset.mobileSrc = member.mobileImg || member.img;
...
function initOMMaintenanceVideo() {
  ...
  /* On phones, defer the maintenance video until it is actually visible.
     Desktop behavior remains unchanged. */
  if (window.matchMedia('(max-width: 700px)').matches && 'IntersectionObserver' in window) {
    video.preload = 'none';
    let requested = false;
  ...
  } else if (video.readyState >= 2) playVideo();
...
function resolveAssetUrl(src) {
  if (!src) return '';
  // Keep gallery sources relative to the document. This is more reliable for
  // both file:/// Windows deployments and normal http(s) hosting than forcing
  // an absolute URL string into the image element.
  return String(src).replace(/\\/g, '/');
}

function updateLightboxThumbs() {
  if (!lightboxThumbs) return;
  const html = lightboxList.map((item, idx) => {
    const thumbSrc = resolveAssetUrl(item.g.src);
    return `<button class="lightbox-thumb ${idx === lightboxIndex ? 'is-active' : ''}" type="button" data-lightbox-index="${idx}" aria-label="View image ${idx + 1}">
      <img src="${esc(thumbSrc)}" alt="" loading="lazy" decoding="async">
    </button>`;
  }).join('');
  lightboxThumbs.innerHTML = html;
}

function updateLightboxThumbState() {
  if (!lightboxThumbs) return;
  $$('.lightbox-thumb', lightboxThumbs).forEach((thumb, idx) => {
    const active = idx === lightboxIndex;
    thumb.classList.toggle('is-active', active);
    thumb.setAttribute('aria-current', active ? 'true' : 'false');
  });
  lightboxThumbs.querySelector('.lightbox-thumb.is-active')?.scrollIntoView({
...
function showLightboxImage() {
  ...
  lightboxImg.classList.remove('is-error');
  lightboxImg.alt = g.cap || 'Project image';
  lightboxImg.decoding = 'async';
  lightboxImg.loading = 'eager';
  lightboxImg.style.removeProperty('display');
  lightboxImg.style.removeProperty('visibility');
  lightboxImg.style.removeProperty('opacity');

  if (lightboxCaption) lightboxCaption.textContent = g.cap || '';
  if (lightboxCounter) lightboxCounter.textContent = `${lightboxIndex + 1} / ${lightboxList.length}`;

  const hasNavigation = lightboxList.length > 1;
  const prevButton = $('.lightbox-prev', lightboxEl);
  const nextButton = $('.lightbox-next', lightboxEl);
  [prevButton, nextButton].forEach(btn => {
    if (!btn) return;
    btn.disabled = !hasNavigation;
    btn.setAttribute('aria-disabled', String(!hasNavigation));
  });

  // Build thumbnails only when the gallery is first opened or its group changes.
  if (!lightboxThumbs.querySelector('.lightbox-thumb') ||
      lightboxThumbs.children.length !== lightboxList.length) {
    updateLightboxThumbs();
  } else {
    updateLightboxThumbState();
  }

  // Keep the actual image element alive and assign the relative asset path
  // directly. This avoids the blank-image failure caused by removeAttribute()
  // plus an opacity/state-class dependency.
  lightboxImg.onload = () => {
    lightboxImg.classList.remove('is-error');
  ...
  lightboxImg.onerror = () => {
    ...
    lightboxImg.classList.add('is-error');
    lightboxImg.setAttribute('aria-busy', 'false');
    lightboxImg.alt = 'Project image could not be loaded';
    if (lightboxCaption) lightboxCaption.textContent = `${g.cap || 'Project image'} — image unavailable`;
  };
  ...
  if (hasNavigation) {
    [-1, 1].forEach(offset => {
      const next = lightboxList[(lightboxIndex + offset + lightboxList.length) % lightboxList.length];
      if (!next) return;
      const preload = new Image();
      preload.decoding = 'async';
      preload.src = resolveAssetUrl(next.g.src);
    });
  }
...
// Mobile browsing: swipe the main image only. The thumbnail strip keeps its
// native horizontal scrolling and never accidentally changes the image.
let lightboxTouchX = 0;
let lightboxTouchY = 0;
let lightboxTouchActive = false;
lightboxImg?.addEventListener('touchstart', (e) => {
  if (e.touches.length !== 1 || lightboxList.length < 2) return;
  lightboxTouchX = e.touches[0].clientX;
  lightboxTouchY = e.touches[0].clientY;
  lightboxTouchActive = true;
}, { passive: true });
lightboxImg?.addEventListener('touchend', (e) => {
  if (!lightboxTouchActive || lightboxList.length < 2) return;
